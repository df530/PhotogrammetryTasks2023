...
{
    cv::Mat transformedPoint = T * cv::Vec3d(pt.x, pt.y, 1.0);
    return {transformedPoint.at<double>(0) / transformedPoint.at<double>(2),
            transformedPoint.at<double>(1) / transformedPoint.at<double>(2)};
}
